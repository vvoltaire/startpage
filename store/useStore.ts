...
const SEED: CardData[] = [
  // ── Notes ─────────────────────────────────────────────────────────────────
  { id: 'seed-note-art', type: 'note', x: 0, y: 0, width: 300, height: 156, zIndex: 2,
  ...
  { id: 'seed-note-music', type: 'note', x: 0, y: 0, width: 300, height: 156, zIndex: 2,
  ...
  { id: 'seed-note-code', type: 'note', x: 0, y: 0, width: 300, height: 156, zIndex: 2,
    data: { text: 'Dev To-Do\n\n• Homebase: Supabase sync\n• Deploy to Vercel\n• Fix Canvas TS errors\n• Gallery mode (Phase 6)\n• Magnetic card snapping' },
    tags: ['code'], starred: true },
  { id: 'seed-note-inspo', type: 'note', x: 0, y: 0, width: 300, height: 156, zIndex: 2,
    data: { text: 'Current Aesthetic\n\n• Japanese minimalism\n• Brutalist architecture\n• Muted earth + indigo tones\n• Clean geometric sans-serif' },
    tags: ['inspiration'], starred: false },

  // ── Art ──────────────────────────────────────────────────────────────────
  { id: 'seed-art-blender-manual', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://docs.blender.org/manual/en/latest/' },
    tags: ['art'], starred: false },
  { id: 'seed-art-donut', type: 'youtube', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
  ...
  { id: 'seed-art-stylized', type: 'youtube', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    ...
    tags: ['art'], starred: false },
  { id: 'seed-art-artstation', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.artstation.com/search?sort_by=trending' },
    tags: ['art'], starred: false },
  { id: 'seed-art-behance', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.behance.net/galleries/graphic-design' },
    tags: ['art'], starred: false },
  { id: 'seed-art-conceptart', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://conceptartworld.com/' },
    tags: ['art'], starred: false },
  { id: 'seed-art-sketchfab', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://sketchfab.com/feed' },
    tags: ['art'], starred: false },
  { id: 'seed-art-procreate', type: 'youtube', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    ...
    tags: ['art'], starred: true },
  { id: 'seed-art-krita', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://krita.org/en/' },
    tags: ['art'], starred: false },
  { id: 'seed-art-gnomon', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.thegnomonworkshop.com/' },
    tags: ['art'], starred: false },

  // ── Music ─────────────────────────────────────────────────────────────────
  { id: 'seed-music-clarity', type: 'youtube', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
  ...
  { id: 'seed-music-genius', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://genius.com/Zedd-clarity-lyrics' },
    tags: ['music'], starred: false },
  { id: 'seed-music-justin', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.justinguitar.com/classes/beginner-guitar-course-grade-1' },
    tags: ['music'], starred: false },
  { id: 'seed-music-samplemagic', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.samplemagic.com/' },
    tags: ['music'], starred: false },
  { id: 'seed-music-splice', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://splice.com/sounds/search/samples' },
    tags: ['music'], starred: false },
  { id: 'seed-music-ableton', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://learningsynths.ableton.com/' },
    tags: ['music'], starred: true },
  { id: 'seed-music-sos', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.soundonsound.com/' },
    tags: ['music'], starred: false },
  { id: 'seed-music-pitchfork', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://pitchfork.com/reviews/albums/' },
    tags: ['music'], starred: false },
  { id: 'seed-music-lofi', type: 'youtube', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    ...
    tags: ['music'], starred: true },
  { id: 'seed-music-ni', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.native-instruments.com/en/' },
    tags: ['music'], starred: false },

  // ── Code ──────────────────────────────────────────────────────────────────
  { id: 'seed-code-framer', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.framer.com/motion/' },
    tags: ['code'], starred: true },
  { id: 'seed-code-react', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://github.com/facebook/react' },
    tags: ['code'], starred: false },
  { id: 'seed-code-supabase', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://supabase.com/docs' },
    tags: ['code'], starred: true },
  { id: 'seed-code-mdn', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout' },
    tags: ['code'], starred: false },
  { id: 'seed-code-stackoverflow', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://stackoverflow.com/questions?sort=featured' },
    tags: ['code'], starred: false },
  { id: 'seed-code-nextjs', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://nextjs.org/docs' },
    tags: ['code'], starred: true },
  { id: 'seed-code-tailwind', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://tailwindcss.com/docs/installation' },
    tags: ['code'], starred: false },
  { id: 'seed-code-devto', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://dev.to/' },
    tags: ['code'], starred: false },
  { id: 'seed-code-codepen', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://codepen.io/trending' },
    tags: ['code'], starred: false },
  { id: 'seed-code-threejs', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://threejs.org/examples/' },
    tags: ['code'], starred: true },

  // ── Inspiration ───────────────────────────────────────────────────────────
  { id: 'seed-inspo-pinterest', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.pinterest.com/search/pins/?q=minimalism%20aesthetic' },
    tags: ['inspiration'], starred: false },
  { id: 'seed-inspo-awwwards', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.awwwards.com/websites/' },
    tags: ['inspiration'], starred: true },
  { id: 'seed-inspo-designfiles', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://thedesignfiles.net/' },
    tags: ['inspiration'], starred: false },
  { id: 'seed-inspo-unsplash', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://unsplash.com/t/architecture-interior' },
    tags: ['inspiration'], starred: true },
  { id: 'seed-inspo-arena', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.are.na/explore' },
    tags: ['inspiration'], starred: false },
  { id: 'seed-inspo-designmilk', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://design-milk.com/' },
    tags: ['inspiration'], starred: false },
  { id: 'seed-inspo-itsnicethat', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.itsnicethat.com/' },
    tags: ['inspiration'], starred: true },
  { id: 'seed-inspo-abduzeedo', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://abduzeedo.com/' },
    tags: ['inspiration'], starred: false },
  { id: 'seed-inspo-dribbble', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://dribbble.com/shots' },
    tags: ['inspiration'], starred: true },
  { id: 'seed-inspo-archdaily', type: 'link', x: 0, y: 0, width: 300, height: 186, zIndex: 2,
    data: { url: 'https://www.archdaily.com/' },
    tags: ['inspiration'], starred: false },
];

interface AddCardInput extends Omit<CardData, 'id' | 'zIndex'> {
  zIndex?: number;
  id?: string;
}
    ...
    (set) => ({
      ...
      addCard: (card) =>
        set((state) => {
          ...
          return {
            cards: [...state.cards, { ...card, id, zIndex }],
            maxZIndex: nextMax,
          };
        }),
      ...
      toggleHiddenTag: (tag) =>
        set((state) => ({
          hiddenTags: state.hiddenTags.includes(tag)
            ? state.hiddenTags.filter((t) => t !== tag)
            : [...state.hiddenTags, tag],
        })),
      setView: (view) =>
        set((state) => ({
          view,
          editMode: view === 'home' ? false : state.editMode,
        })),
